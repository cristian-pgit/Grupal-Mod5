				...
				<form action="CrearUsuario" method="post">
					<!-- <div class="form-group">
						<label class="text-center" for="idpro">Id Profesional: </label> <input
							type="number" class="form-control" id=""idpro"" required
							name=""idpro"">
					</div> -->
					<div class="form-group">
						<label class="text-center" for="titulo">Titulo Profesional: </label> 
